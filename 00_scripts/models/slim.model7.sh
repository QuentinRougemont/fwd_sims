...
12685  {
p1.setMigrationRates(p3, 0.15);
p2.setMigrationRates(p3, 0.225);
}
...
combined=c(pop2,pop1,pop3); combined.genomes.outputVCF(filePath="02_vcf/model7/slim.__NB__.vcf",outputMultiallelics=F);}
