...
12685  {
p1.setMigrationRates(p3, 0.20);
p2.setMigrationRates(p3, 0.30);
}
...
combined=c(pop2,pop1,pop3); combined.genomes.outputVCF(filePath="02_vcf/model5/slim.__NB__.vcf",outputMultiallelics=F);}
